...
<title>Esp_FH Aachen: Startseite</title>
...
<div id="PAGE">
    ...
    <div ID="HEADER">
        ...
        <div id="TOPNAV"><span id="hilfsnavi_topnavi" class="invisible"><a href="#hilfsnavi_sprachwahl">Top-Navigation &uuml;berspringen</a></span>
            <a href="index_es.php" title="Home">Home</a><a href="kontakt/" title="Contact">Contact</a><a href="#" title="about us">About us</a>
        </div>
        <div id="LOGIN">    
...
<script language="javascript">
  if ("<div></div>">"" && "<div></div>"!="<div></div>") {
	...
	<center><a href="build_es.html"><span class="box1">Construya el auto de sus sue&ntilde;os</span></a></center>
